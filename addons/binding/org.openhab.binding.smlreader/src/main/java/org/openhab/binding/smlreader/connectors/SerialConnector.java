...
public final class SerialConnector extends ConnectorBase {
    ...
    protected void openConnection() throws IOException {
        ...
        try {
            ...
            CommPortIdentifier portId = CommPortIdentifier.getPortIdentifier(canonicalPath);
            RXTXPort commPort = portId.open("SmlReaderBinding", 2000);
            serialPort = commPort; // serialPortFactory.createSerialPort(portName);
